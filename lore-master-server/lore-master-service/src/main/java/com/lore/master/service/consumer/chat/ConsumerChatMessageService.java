...
@Slf4j
@Service
public class ConsumerChatMessageService {
     ...
     */
    @Transactional
    public ConsumerChatMessage saveUserMessage(String userId, String content) {
     ...
     */
    @Transactional
    public ConsumerChatMessage saveAssistantMessage(String userId, String content, String modelName) {
        String sessionId = "session_" + userId; // 简化：每个用户一个会话
     ...
     */
    public List<ConsumerChatMessage> getRecentMessages(String userId, int maxMessages) {
     ...
     * 获取用户的所有消息（分页）
     */
    public List<ConsumerChatMessage> getUserMessages(String userId, int page, int size) {
        String sessionId = "session_" + userId;
