...
CREATE TABLE users (
    ...
    education ENUM('high_school', 'college', 'bachelor', 'master', 'doctor', 'other') COMMENT '学历',
...
CREATE TABLE user_knowledge_mastery (
    ...
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户知识点掌握情况表';
...
CREATE TABLE ai_assessments (
    ...
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI测评记录表';
...
CREATE TABLE personalized_learning_plans (
    ...
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='个性化学习计划表';
...
CREATE TABLE learning_behavior_analytics (
    ...
    INDEX idx_create_time (create_time),
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='学习行为分析表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='向量数据库映射表';
...
('testuser1', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iKXIgBZdO5jO8S5V8jDgmKYeQ3Eq', '测试用户1', 'test1@example.com', 1),
('testuser2', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iKXIgBZdO5jO8S5V8jDgmKYeQ3Eq', '测试用户2', 'test2@example.com', 1);
