...
export const API_PATHS = {
  ...
  ADMIN: {
    ...
    SKILL_CATALOG: {
      PAGE: '/api/admin/skill-catalog/page',
      LIST: '/api/admin/skill-catalog/list',
      TREE: '/api/admin/skill-catalog/tree',
      CREATE: '/api/admin/skill-catalog/create',
      UPDATE: '/api/admin/skill-catalog/update',
      DELETE: '/api/admin/skill-catalog/delete',
      BATCH_DELETE: '/api/admin/skill-catalog/batch-delete',
      GET: '/api/admin/skill-catalog/get',
      GET_BY_CODE: '/api/admin/skill-catalog/get-by-code',
      FIRST_LEVEL: '/api/admin/skill-catalog/first-level',
      CHILDREN: '/api/admin/skill-catalog/children',
      LEVEL: '/api/admin/skill-catalog/level',
      TOGGLE_STATUS: '/api/admin/skill-catalog/toggle-status',
      BATCH_TOGGLE_STATUS: '/api/admin/skill-catalog/batch-toggle-status',
      ADJUST_SORT: '/api/admin/skill-catalog/adjust-sort',
      MOVE: '/api/admin/skill-catalog/move',
      COPY: '/api/admin/skill-catalog/copy',
      EXISTS_CODE: '/api/admin/skill-catalog/exists-code',
